...
export interface LibraryExercise {
  ...
  englishName: string;
  wikiSlug: string;       // English Wikipedia article slug for image + summary
  primaryMuscle: string;  // Czech
  description: string;    // Czech technical description
  tips: string[];         // Czech form cues
}
...
const LEGS: LibraryExercise[] = [
  ...
  },
  {
    ...
    wikiSlug: 'Leg_extension_(exercise)',
  ...
  },
  {
    ...
    wikiSlug: 'Goblet_squat',
    primaryMuscle: 'Kvadricepsy · Hýžďové svaly · Core',
    description:
      'Skvělá varianta dřepu s činkou nebo kettlebellem před tělem. Díky přední zátěži přirozeně udržuje trup vzpřímený a je ideální pro nácvik techniky.',
    tips: [
